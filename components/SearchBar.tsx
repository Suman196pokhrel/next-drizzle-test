...
const SearchBar = ({ todoData, searchQuery, setSearchQuery }: SearchBarProps) => {
    ...
    return (
        <div className="flex items-center gap-5 relative group">
            <Input type="search" value={searchQuery} disabled={!todoData} onChange={(e) => setSearchQuery(e.target.value)} placeholder="search for your todos . . ." className="pl-14 focus-visible:ring-0 peer focus-visible:pl-5 transition-all duration-200 " />
